...
const UpdateLabAppointmentModal = ({ appointment, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/lab-appointment/${appointment._id}`, {
        method: 'PUT',
        headers: {
...
export default UpdateLabAppointmentModal;
